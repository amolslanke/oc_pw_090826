...
Error: locator.click: Error: strict mode violation: locator('text=My Account') resolved to 3 elements:
    ...
    3) <a href="https://tutorialsninja.com/demo/index.php?route=account/account">My Account</a> aka getByRole('link', { name: 'My Account', exact: true })
...
```ts
  ...
  15 |         this.page=page;
  16 |         this.lnkMyAccount=page.locator("text=My Account");
  17 |         this.lnkRegister=page.locator("text=Register");
  18 |         this.linkLogin=page.locator("text=Login");
  19 |         this.txtSearchbox=page.locator("input[name='search']");
  20 |         this.btnSearch=page.locator("button[class='btn btn-default btn-lg']");
  21 |     }
  22 | 
  23 |     // Check if HomePage exists
  ...
  31 |     }
  32 | 
  33 |     // Click "My Account" link
  34 |     async clickMyAccount(){
  35 |         try {
> 36 |             await this.lnkMyAccount.click();
     |                                     ^ Error: locator.click: Error: strict mode violation: locator('text=My Account') resolved to 3 elements:
  37 |         } catch (error) {
  38 |             console.log(`Exception occurred while clicking 'My Account': ${error}`);
  39 |             throw error;
  40 |         }
  41 |     }
  42 | 
